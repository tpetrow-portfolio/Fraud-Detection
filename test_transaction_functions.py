...
def test_generate_charge():
    # Generate a charge
    charge = generate_transaction()

    # Check the type of the returned object
    assert isinstance(charge, Transaction), "The returned object is not an instance of Charge."
...
def test_randomization():
    ...
    charge1 = generate_transaction()
    charge2 = generate_transaction()
...
testCharge = Transaction("TestTransaction", "TestCustomer", None, "Test Store", "Test Category", 
                        100.00, "America", "MasterCard","Approved","Online")
testCharge2 = Transaction("TestTransaction2", "TestCustomer", None, "Test Store", "Test Category", 
                        100.00, "America", "MasterCard","Approved","Online")
